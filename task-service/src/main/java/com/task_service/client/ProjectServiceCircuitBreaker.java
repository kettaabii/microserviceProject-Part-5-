...
@Configuration
public class ProjectServiceCircuitBreaker {

    @Bean
    public CircuitBreakerRegistry circuitBreakerRegistry() {
        CircuitBreakerConfig projectServiceConfig = CircuitBreakerConfig.custom()
        ...
        registry.addConfiguration("projectService", projectServiceConfig);
        return registry;
    }
