...
@Configuration
public class ResourceServiceCircuitBreaker {

    @Bean
    public CircuitBreakerRegistry circuitBreakerRegistry() {
        CircuitBreakerConfig resourceServiceConfig = CircuitBreakerConfig.custom()
        ...
        registry.addConfiguration("resourceService", resourceServiceConfig);
        return registry;
    }
